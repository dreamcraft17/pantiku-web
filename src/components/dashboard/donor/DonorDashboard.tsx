    ...
    <ProtectedDashboard allowedRoles={["DONOR"]}>
      <DashboardLayout>
        ...
        <DashboardSection title="Latest Contribution">
          {!latestContribution ? (
            <EmptyState title="Belum ada kontribusi" description="Belum ada kontribusi. Mulai dengan mendukung campaign pertama kamu." />
          ) : (
        ...
        <DashboardSection title="Recommended Campaigns" description="Pilih campaign produktif berikut untuk kontribusi berikutnya.">
          {recommendedCampaigns.length === 0 ? (
            <EmptyState title="Belum ada campaign yang didukung" description="Jelajahi campaign untuk mulai dukung campaign pertama kamu." />
          ) : (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <DashboardSection title="Latest Impact Updates">
          {impactUpdatesFromSupportedCampaigns.length === 0 ? (
            <EmptyState title="Belum ada update dampak" description="Belum ada update dampak. Dukung campaign untuk mulai melihat dampaknya." />
          ) : (
