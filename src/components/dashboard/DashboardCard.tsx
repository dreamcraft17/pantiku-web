...
export function DashboardCard({ title, description, ctaLabel, href, disabled = false, disabledReason }: Props) {
  return (
    <article className="rounded-2xl border border-emerald-100 bg-white p-6 text-left shadow-sm">
